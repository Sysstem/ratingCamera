...
Вот обновленный список с актуальными методами вычисления:

### Основные метрики
- **Резкость (25%)** - Четкость деталей изображения (**Laplacian Variance, Gradient Analysis**)
- **Шум (20%)** - Уровень цифрового шума (**Homogeneous Region Analysis, High-frequency Noise, JPEG Blocking Artifacts**)
- **Цветопередача (15%)** - Точность воспроизведения цветов (**Saturation Analysis, Channel Balance**)
- **Контраст (15%)** - Динамический диапазон (**RMS Contrast, Percentile Range**)

### Дополнительные метрики
- **Экспозиция (10%)** - Правильность освещения (**Histogram Percentiles, Clipping Analysis, Tone Distribution**)
- **Искажения (10%)** - Геометрические искажения (**Hough Transform, Line Curvature Analysis**)
- **Хроматические аберрации (5%)** - Цветовые искажения (**Channel Gradient Discrepancy, Edge Color Analysis**)

## 🔍 Детализация методов:

### **Резкость**
- **Laplacian Variance** - дисперсия оператора Лапласа
- **Gradient Analysis** - анализ высокочастотных компонентов

### **Шум** 
- **Homogeneous Region Analysis** - поиск и анализ однородных областей
- **High-frequency Noise** - разность соседних пикселей
- **JPEG Blocking Artifacts** - анализ границ блоков сжатия

### **Цветопередача**
- **Saturation Analysis** - вычисление цветовой насыщенности
- **Channel Balance** - анализ баланса RGB каналов

### **Контраст**
- **RMS Contrast** - среднеквадратичный контраст с коррекцией яркости
- **Percentile Range** - разность 5-го и 95-го процентилей гистограммы

### **Экспозиция**
- **Histogram Percentiles** - анализ медианы и распределения яркости
- **Clipping Analysis** - обнаружение пересветов и недосветов
- **Tone Distribution** - оценка деталей в тенях/светах/средних тонах

### **Искажения**
- **Hough Transform** - детектирование прямых линий
- **Line Curvature Analysis** - анализ отклонений от идеальных прямых

### **Хроматические аберрации**
- **Channel Gradient Discrepancy** - сравнение градиентов в RGB каналах
- **Edge Color Analysis** - анализ цветовых окантовок на краях
